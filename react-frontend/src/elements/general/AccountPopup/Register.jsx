    ...
    return (
        <div className={`register ${isVisible ? "" : "hidden"}`}>
            ...
            */}
            ...
            <RegisterDetails inputsData={[{label: "Phone Number"}]}/>
...
function RegisterDetails({ inputsData }) {
    ...
    const inputComponents = inputsData.map((data, i) => {
        ...
        switch (type) {
            ...
            default:
                return <Input key={i} label={label} type={type} id={id} small={small} i={i} />
        }
...
function Input({label, id, small, i, type }) {
    return(
